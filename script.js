...
function updatePose(){const c=characters[selected];$('shot-counter').textContent=`${Math.min(shot+1,4)} / 4`;$('character-overlay').src=`images/${c.folder}/${poses[Math.min(shot,3)]}`;}
